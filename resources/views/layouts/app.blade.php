    ...
    <div id="publishJobModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" onclick="hidePublishJobModal()">
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full p-6 md:p-8 transform transition-all" onclick="event.stopPropagation()">
            <div class="text-center">
                ...
                <div class="bg-blue-50 rounded-lg p-3 md:p-4 mb-4 md:mb-6 text-left">
                    <ul class="space-y-2 text-sm text-gray-700">
                        <li class="flex items-start">
                            <span class="text-green-600 mr-2 flex-shrink-0">✓</span>
                ...
                <button onclick="hidePublishJobModal()" class="w-full px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 font-medium transition-colors min-h-[44px]">
                    Got it!
                </button>
            </div>
        </div>
